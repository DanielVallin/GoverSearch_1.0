...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-05-2021 a las 01:15:32
...
INSERT INTO `tbl_gestion` (`pk_Gestionid`, `Ley_pk`, `Fecha`, `FUltReforma`, `FEntradaVigo`, `EstLey`, `ObjLey`, `TipoLey`, `Introduccion`, `Num_Articulo`, `Tipo`, `Titulo`, `Ref_Titulo`, `NomTitulo`, `Capitulo`, `Ref_Capitulo`, `NomCapitulo`, `Fraccion`, `Inciso`, `Parrafo`, `Descripcion`, `UltReforma`, `Concepto`, `Estatus`, `Estado`) VALUES
...
(2, 2, '2021-01-02', '2021-01-01', '2021-01-01', 'Derogada', 'as', 'Estatal', 'ass', 0, 'Transitorio', 'as', 'as', 'as', 11, 'as', 'Daniel Vallin', 'as', 'a', 'as', 'asd55', '2021-12-01', 'asd', 'Normal', b'1');
...
(4, 'Usuario ss', 'Solo acceso basicos', b'1'),
(5, 'saaa', 'sasd', b'1');
...
--
ALTER TABLE `tbl_gestion`
  MODIFY `pk_Gestionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_permisos`
  MODIFY `pk_Permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tbl_roles`
--
ALTER TABLE `tbl_roles`
  MODIFY `pk_Rol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `tbl_ter_clave`
  ...
  ADD CONSTRAINT `fk_Ter_Clave` FOREIGN KEY (`Termino_Clave_pk`) REFERENCES `tbl_claves` (`pk_Ter_Clave`) ON DELETE CASCADE ON UPDATE CASCADE;
